 ...
 *
 */
@Service("queryWithdrBankHandler")
@Slf4j
public class QueryWithdrBankHandlerImpl extends BaseBusiHandlerImpl implements BaseBusiHandler{
	...
	public void doBusi(RequestMsg requestMsg, ResponseMsg responseMsg) throws Exception {
		...
		List<CardBindVO> cardBindList = cardBindService.withdrBankList(requestMsg.getMap());
