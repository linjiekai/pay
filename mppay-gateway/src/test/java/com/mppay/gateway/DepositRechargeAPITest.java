...
@SpringBootTest
public class DepositRechargeAPITest extends BaseTest{
	...
	public void testDepositRechargeAPI() throws Exception {
		...
		map.put("busiType", BusiType.INCOME.getId());
		map.put("bankCode", BankCode.MPPAY.getId());
