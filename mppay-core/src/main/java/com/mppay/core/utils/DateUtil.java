...
public class DateUtil {
    ...
    public static final String DATEFORMAT_9 = "yyyyMMddHHmmss";
    public static final String DATEFORMAT_10 = "yyyyMMdd";
    ...
    public static String localDateTimeToString(LocalDateTime dataTime) {
        DateTimeFormatter df = DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss");
    ...
    public static void main(String[] args) throws Exception {
        String s1 = DateTimeUtil.formatDateStringToString("2020-04-23 12:50:20", DateUtil.DATE_TIME_PATTERN, DateUtil.DATE_PATTERN);
